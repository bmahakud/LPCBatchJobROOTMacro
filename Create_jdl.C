...
write<<"Executable = jobExecCondor.sh"<<endl;
...
write<<"Transfer_Input_Files = jobExecCondor.sh,MasterReaderAdvanced.C,ClassReadTree.cc,MasterReaderAdvanced_C.so"<<endl;
